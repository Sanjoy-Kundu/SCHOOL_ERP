    ...
    Object.keys(grouped).forEach(groupName => {
        ...
        subjectKeys.forEach((subjectName, sIdx) => {
            ...
            if (!subjectObj.has_papers) {
                ...
                papersTdHtml = `<td colspan="2" class="text-center text-secondary align-middle fw-semibold">${subjectName}${codeText}${delBtn}</td>`;
            } else {
                ...
                let p1Html = '—';
                 if (p1) {
                    ...
                    p1Html = `${p1.subject?.name || '—'} ${p1.paper?.name || '—'}${codeText}${delBtn}`;
                }
                ...
                let p2Html = '—';
                    ...
                    p2Html = `${p2.subject?.name || '—'} ${p2.paper?.name || '—'}${codeText}${delBtn}`;
                }
